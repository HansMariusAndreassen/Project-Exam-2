...
/**
 * Profile component displays the user profile information, including avatar, banner, bio, venues, and bookings.
 * It allows the user to edit their profile, add venues, and manage bookings.
 *
 * @component
 * @example
 * return (
